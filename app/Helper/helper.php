...
//         $emailTo = str_replace("'", "", $to->email);

//         $mail->setFrom('no-reply@mail.com', env('APP_NAME','Course Bangla Student'));
...
//         } 
//         if (!$mail->send()) {
//             $remarks = "Email could not be sent. Mailer Error: $mail->ErrorInfo";
//             \Log::info($remarks);
//         } else {
...
//         \Log::info('check message:'.$request['message']);
...
//           \Log::info('request before send'.json_encode($request['message']));
