...
class AdminController extends Controller
{
    ...
    public function usersReports()
    {
        ...
        $courseCount = Content::where('type', '=', 'course')->count();
        $venuCount   = Content::where('type', '=', 'venu')->count();
    ...
    public function userRateSection($id, Request $request)
    {
        ...
        $userR = User::find($id);
        ## Notification Center
        sendNotification(0, ['[u.name]' => $userR->name, '[u.username]' => $userR->username, '[u.m.title]' => $userRate->description], get_option('notification_template_get_medal'), 'user', $id);
    ...
    public function contentLists(Request $request)
    {
        ...
        $lists = $lists->where('type', 'course')->paginate(10);
    ...
    public function venuLists(Request $request)
    {
        $fdate = strtotime($request->get('fdate', null)) + 12600;
        $ldate = strtotime($request->get('ldate', null)) + 12600;
        ...
        $lists = $lists->where('type', 'venu')->paginate(10);
        ...
        return view('admin.venu.list', $data);
    }
    ...
    public function contentWaitingList(Request $request)
    {
        ...
        $lists = $lists->where('type', 'course')->paginate(15);
    ...
    public function venuWaitingList(Request $request)
    {
        $fdate = strtotime($request->get('fdate', null)) + 12600;
        $ldate = strtotime($request->get('ldate', null)) + 12600;
        ...
        $lists = $lists->where('type', 'venu')->paginate(15);
        ...
        return view('admin.venu.waiting', ['lists' => $lists, 'users' => $users, 'category' => $category]);
    }
    ...
    public function venuDraftList(Request $request)
    {
        $fdate = strtotime($request->get('fdate', null)) + 12600;
        $ldate = strtotime($request->get('ldate', null)) + 12600;
    ...
    public function venuComments()
    {
        $comments = ContentComment::with('content')->orderBy('id', 'DESC')->get();
        return view('admin.venu.comments', ['comments' => $comments]);
    }
    ...
    public function listFacility() {
        $list = CourseFacility::where('is_show', '1')->get();
        return view('admin.content.facility', array('lists' => $list));
        
    }
    
    public function storeFacility(Request $request) {
       
        $facility = new CourseFacility();
        $facility->name    = $request->input('name');
        $facility->is_show = $request->input('status');
        $facility->save();
        
        return back()->with('Course facility create successfully');
    }
    
    public function editFacility($id) {
        
        $facility = CourseFacility::find($id);
        return view('admin.content.edit_facility', array('facility' => $facility));
    }
    ...
    public function updateFacility($id, Request $request) {
        ...
        return redirect('admin/content/facility-list')->with('Course facility update successfully');
    }
    
    public function deleteFacility($id) {
        CourseFacility::find($id)->delete();
        return back();
    }
    
    public function listInstructor() {
        // dd(1);
        $list = InstructorInfo::where('is_active', '1')->get();
        return view('admin.content.instructor', array('lists' => $list));
    ...
    public function storeInstructor(Request $request) {
        ...
        $instructor->is_active  = $request->input('status');
        ...
        if ($request->file('photo')) {
            ...
            if(!in_array($mime_type,['image/jpeg','image/jpg','image/png'])){
                return redirect('user/content/instructor-list')->with('flash_danger','Image must be png or jpg or jpeg format!');
            }
            ...
            $photo->move('uploads/instructor_images/', $photoFile);
            $instructor->image = $photoFile;
        }
        $instructor->save();
        
        return back()->with('Course instructor create successfully');
    }
    
    public function editInstructor($id) {

        $instructor = InstructorInfo::find($id);
        return view('admin.content.edit_instructor', array('instructor' => $instructor));
    }
    ...
    public function updateInstructor($id, Request $request) {
        ...
        return redirect('admin/content/instructor-list')->with('Course instructor update successfully');
    }
    
    public function deleteInstructor($id) {
        InstructorInfo::find($id)->delete();
        return back();
    }
    
    public function listFeature(Request $request) {
        $list = VenuFeature::where('is_show', '1')->get();
        return view('admin.content.feature', array('lists' => $list));
        
    }
    
    public function storeFeature(Request $request) {

        $facility = new VenuFeature();
        $facility->name    = $request->input('name');
        $facility->is_show = $request->input('status');
        $facility->payment_status = $request->input('payment_status');
        $facility->save();
        
        return back()->with('Venu features create successfully');
    }
    
    public function editFeature($id) {
        
        $facility = VenuFeature::find($id);
        return view('admin.content.edit_feature', array('feature' => $facility));
    }
    ...
    public function updateFeature($id, Request $request) {
        ...
        return redirect('admin/content/feature-list')->with('Venu feature update successfully');
    }
    
    public function deleteFeature($id) {
        VenuFeature::find($id)->delete();
        return back();
    }
