...
Route::group(['prefix' => 'user'], function () {
    Route::group(['middleware' => ['user', 'notification']], function () {
        ...
        Route::group(['prefix' => 'gallery'], function () {
            Route::get('', 'UserController@galleryList');
            Route::get('delete/{id}', 'UserController@galleryDelete');
            Route::get('request/{id}', 'UserController@contentRequest');
            Route::get('draft/{id}', 'UserController@contentDraft');
            Route::get('create', 'UserController@contentNew');
            Route::post('new/store', 'UserController@galleryStore');
        });
        ...
        Route::group(['prefix' => 'social'], function () {
            Route::get('', 'UserController@socialList');
            Route::get('delete/{id}', 'UserController@socialDelete');
            Route::get('request/{id}', 'UserController@contentRequest');
            Route::get('draft/{id}', 'UserController@contentDraft');
            Route::post('new/store', 'UserController@socialStore');
        });
        ...
        Route::group(['prefix' => 'instructor'], function () {
            Route::get('', 'UserController@instructorList');
            Route::get('delete/{id}', 'UserController@instructorDelete');
            Route::get('request/{id}', 'UserController@instructorRequest');
            Route::get('draft/{id}', 'UserController@instructorDraft');
            Route::post('new/store', 'UserController@instructorStore');
        });
        ...
        Route::group(['prefix' => 'venu'], function () {
            Route::get('', 'UserController@venuList');
            Route::get('delete/{id}', 'UserController@contentDelete');
            Route::get('request/{id}', 'UserController@contentRequest');
            Route::get('draft/{id}', 'UserController@contentDraft');
            Route::get('new', 'UserController@contentNew');
            // Route::get('course/create', 'UserController@creteCourse');
            // Route::get('venu/create', 'UserController@createVenu');
        ...
        Route::group(['prefix' => 'content'], function () {
            ...
            Route::get('draft/{id}', 'UserController@contentDraft');
            Route::get('new', 'UserController@contentNew');
            Route::get('course/create', 'UserController@createCourse');
            Route::post('course/store', 'UserController@storeCourse');
            Route::get('venu/create', 'UserController@createVenu');
            Route::get('venu/store', 'UserController@storeVenu');
            Route::post('venu/store', 'UserController@storeVenu');
            Route::get('venu_edit/{id}', 'UserController@venuEdit');
            Route::get('venu_delete/{id}', 'UserController@venuDelete');
            Route::post('venu_update/{id}', 'UserController@venuUpdate');
            Route::post('new/store', 'UserController@contentStore');
            Route::get('edit/{id}', 'UserController@contentEdit');
            Route::post('course/update/{id}', 'UserController@contentUpdate');
            // Route::post('edit/store/{id}', 'UserController@contentUpdate');
            Route::post('edit/store/request/{id}', 'UserController@contentUpdateRequest');
            Route::post('edit/meta/store/{id}', 'UserController@contentMetaStore');
