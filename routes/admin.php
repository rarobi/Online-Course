    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'content'], function () {
            ...
            Route::get('list/excel', 'AdminController@contentListExcel');
             ...
             ### Venu Section
            Route::get('venu/list', 'AdminController@venuLists');
            Route::get('venu/waiting', 'AdminController@venuWaitingList');
            Route::get('venu/draft', 'AdminController@venuDraftList');
            Route::get('venu/comment', 'AdminController@venuComments');
            ...
            // Route::group(['prefix' => 'facility'], function () {
                Route::get('facility-list', 'AdminController@listFacility');
                Route::post('facility-store', 'AdminController@storeFacility');
                Route::get('facility-edit/{id}', 'AdminController@editFacility');
                Route::post('facility-update/{id}', 'AdminController@updateFacility');
                Route::get('facility-delete/{id}', 'AdminController@deleteFacility');
            // });
            
            ### Venu extra Feature Section
            Route::get('feature-list', 'AdminController@listFeature');
            Route::post('feature-store', 'AdminController@storeFeature');
            Route::get('feature-edit/{id}', 'AdminController@editFeature');
            Route::post('feature-update/{id}', 'AdminController@updateFeature');
            Route::get('feature-delete/{id}', 'AdminController@deleteFeature');
            
            ### Instructor Section
            Route::get('instructor-list', 'AdminController@listInstructor');
            Route::post('instructor-store', 'AdminController@storeInstructor');
            Route::get('instructor-edit/{id}', 'AdminController@editInstructor');
            Route::post('instructor-update/{id}', 'AdminController@updateInstructor');
            Route::get('instructor-delete/{id}', 'AdminController@deleteInstructor');
