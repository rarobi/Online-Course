            ...
            <div class="container">
                <div class="col-md-4 col-xs-12 course_details">
                    ...
                    <div class="product-details-box">
                        ...
                        <span class="pn-category">{{ $product->address }}</span>
                        <!--<span class="pn-category">House-123/3, Mollar Tek, Uttara, Dhaka-1230</span>-->
                    </div>
                    <div class="product-details-box">
                        <span class="proicon mdi mdi-ruler-square"></span>
                        <span> Venu Size- {{ $product->venu_size }} (Sq Ft.)</span>
                    </div>
                    
                    <div class="product-details-box">
                        <span class="proicon mdi mdi-database"></span><span>
                            Free Extra Featured - {{ $product->free_extra_feature }}
                        </span>
                    </div>
                    
                    <div class="product-details-box">
                        <span class="proicon mdi mdi-database"></span><span>
                            Paid Extra Featured - {{ $product->paid_extra_feature }}
                        </span>
                    </div>
                    <div class="product-details-box">
                        <span class="proicon mdi mdi-chair-school"></span>
                        <span>
                            Available Seat- {{ $product->available_seat }}
