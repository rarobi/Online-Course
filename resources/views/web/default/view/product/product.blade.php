            ...
            <div class="container">
                <div class="col-md-4 col-xs-12 course_details">
                    ...
                    <div class="product-details-box">
                        ...
                        <span class="pn-category" style="display:contents">{{ isset($product->address) ? $product->address : 'Not Provided' }}</span>
                    </div>
                    <br>
                    <!--<div class="product-details-box">-->
                    <!--    <span class="proicon mdi mdi-alarm"></span>-->
                    <!--    <span>{{ date('d F Y',$product->created_at) }}</span>-->
                    <!--</div>-->
                    <div class="product-details-box">
                    ...
                    <div class="product-details-box">
                        ...
                        <span>
                            Available Seat {{ isset($product->available_seat) ? $product->available_seat : '0' }}
                    ...
                    <div class="product-price-box">
                        ...
                        @if($product->price != 0)
                            <span id="buy-price">{{ currencySign() }} 
                            @if(isset($product->discount_price))
                                <span style="text-decoration: line-through;color:red;">{{ $product->discount_price }} </span>
                             @endif
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="radio">
                                    ...
                                    &nbsp;
                                    <label class="radio-label" for="mode-1">{{ trans('main.account_charge') }}&nbsp;<b id="credit-remain-modal">({{ $user['credit'] }})</b></label>
                                </div>
                ...
                <div class="modal fade" id="numberModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <h4 class="text-center">Phone Number: {{ isset($product->contact_number) ? $product->contact_number :'Not Provided' }}</h4>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-8 col-xs-12 video-details">
                     <div id="owl-demo">
                         ...
                         <div class="col-md-12">
                             <div class="item"><img src="/uploads/content_sliders/{{ $product_slider->slider  }}" height='425' style="width:100%"></div>
                         </div>
                         @endforeach
                         @else
                         <div class="col-md-12">
                             <div class="item"><img src="{{ asset('/bin/instructor@proacademy.eu/youtube_vimeo.png')  }}" height='425' style="width:100%"></div>
                         </div>
                         @endif
                    </div>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="row">
                        ...
                        <div class="course_details">
                            ...
                            <div class="product-user-box-footer">
                                <a href="/profile/{{ $product->user->id }}"> Company Profile</a>
                            </div>
                            <div class="h-25"></div>
                        </div>
                    </div><br>
                    <div class="row">
                        ...
                        @if(isset($sidebar_top_ad))
                            <a href="{{ $sidebar_top_ad->url }}"><img src="{{ $sidebar_top_ad->image }}" class="col-md-12 col-sm-12 col-xs-12" id="ppage-s"></a>
                        @else
                            <a href="#"><img src="{{ asset('assets/default/images/dummy-add.jpg') }}" class="col-md-12 col-sm-12 col-xs-12" id="ppage-s"></a>    
                        @endif
                    ...
                    <div class="row">
                        ...
                        @if(isset($sidebar_mid_ad))
                            <a href="{{ $sidebar_mid_ad->url }}"><img src="{{ $sidebar_mid_ad->image }}" class="col-md-12 col-sm-12 col-xs-12" style="height:200px"></a>
                        @else
                    ...
                    <div class="row">
                        ...
                        @if(isset($sidebar_bottom_ad))
                            <a href="{{ $sidebar_bottom_ad->url }}"><img src="{{ $sidebar_bottom_ad->image }}" class="col-md-12 col-sm-12 col-xs-12" style="height:200px"></a>
                        @else
                            <a href="#"><img src="{{ asset('assets/default/images/dummy-add.jpg') }}" class="col-md-12 col-sm-12 col-xs-12" style="height:200px"></a>    
                        @endif
                ...
                <div class="col-md-8 col-xs-12 product-part-container">
                    <div class="user-tabs">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <!--@Endif-->
                            <li class="active"><a href="#tab2" role="tab" data-toggle="tab">{{ trans('main.details') }}</a></li>
                            @if($product->live_url)
                                <li><a href="#tab6" role="tab" data-toggle="tab">Program Link</a></li>
                            @endif
                    ...
                    <div class="h-20"></div>
                     ...
                     <div class="row">
                        ...
                        <!--    @foreach($ads as $ad)-->
                        <!--        @if($ad->position == 'product-page')-->
                        <!--            <a href="{{ $ad->url }}"><img src="{{ $ad->image }}" class="{{ $ad->size }}" style="height:200px"></a>-->
                        <!--        @endif-->
                        <!--    @endforeach-->
                        <!--@endif-->
                        @if(isset($slider_course_ad))
                            <a href="{{ $slider_course_ad->url }}"><img src="{{ $slider_course_ad->image }}" class="{{ $slider_course_ad->size }}" style="height:200px"></a>
                        @else
                            <a href="#"><img src="{{ asset('assets/default/images/dummy-add.jpg') }}" class="col-md-12 col-sm-12 col-xs-12" style="height:200px"></a>    
                        @endif
                            ...
                            <div class="owl-carousel">
                                @foreach($related as $rel)
                                    ...
                                    <div class="" dir="rtl" style="margin: 8px;">
                                        <a href="/product/{{ $rel->id }}" title="{{ $rel->title }}" class="content-box ">    
                                            <!--<img alt="{{ $rel->title ?? '' }}" src="{{ $rmeta['thumbnail'] }}"/>-->
                                              @if($rel->thumbnail_photo)
                                                <img src="/uploads/content_thumbnails/{{ $rel->thumbnail_photo }}" class="img img-responsive img-thumbnail">
                                            @else
                                                <img src="{{ url('/assets/default/images/profile_big_icon.png') }}" class="img img-responsive img-thumbnail">
                                            @endif
                                            <p style="float:left;color:#000;">{!! truncate($rel->title,25) !!}</p>
                                            <!--<p style="float:left;">{{ $rel->district }}</p>-->
                                            <!--<p><label class="pull-left">{{ currencySign() }} {{ $rel->price }}</label></p>-->
                                            <div class="footer">
                                                <!--<label class="pull-right content-clock">{{ $rel->district }}</label>-->
                                                <!--<span class="mdi mdi-map-marker pull-right"></span>-->
                                                <span class="mdi mdi-wallet pull-left"></span>
                                                <label class="pull-left">{{ currencySign() }} {{ $rel->price }}</label>
                                            </div>
                                        </a>
                                    </div>
                                @endforeach
    ...
    <script>
        $('.raty').raty({
            starType: 'i', score: {{ ($product->rates->avg('rate')) ? $product->rates->avg('rate') : 0  }}, click: function (rate) {
                window.location = '/product/rate/{{ $product->id ?? '' }}/'+ rate;
            }
        });
    </script>
    <script>
