                ...
                <div class="col-xs-12 row blog-post-box blog-post-box-s">
                    <div class="col-md-4 col-xs-12">
                        ...
                        <div class="product-user-box">
                            <img alt="{{ $post->user->username ?? '' }}" class="img-box" src="{{ !empty($userArticleMeta['avatar']) ? $userArticleMeta['avatar'] : get_option('default_user_avatar','') }}" class="img-responsive"/>
                            <span>{{ $post->user->name }}</span>
                            <div class="user-description-box">
                                {{ !empty($userArticleMeta['short_biography']) ? $userArticleMeta['short_biography'] : '' }}
                            </div>
