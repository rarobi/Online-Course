                        ...
                        <ul class="submenu">
                            ...
                            <form method="post" class="form-horizontal" action="/user/profile/meta/store">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 tab-con">
                                        <input type="text" class="form-control" name="founder_name" value="{!! !empty($meta['founder_name']) ? $meta['founder_name'] : '' !!}">
                                    </div>
                                    <label class="control-label col-md-1 tab-con">Director Name</label>
                                    <div class="col-md-5 tab-con">
                                        <input type="text" name="director_name" value="{{ !empty($meta['director_name']) ? $meta['director_name'] : '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 tab-con">
                                        <input type="text" name="establishment" value="{{ !empty($meta['establishment']) ? $meta['establishment'] : '' }}" class="form-control">
                                    </div>
                                    <label class="control-label col-md-1 tab-con">Branch Office(If)</label>
                                    <div class="col-md-5 tab-con">
                                        <input type="text" name="branch_office" value="{{ !empty($meta['branch_office']) ? $meta['branch_office'] : '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if(is_array(json_decode(get_option('site_language_select'),true)))
                                        ...
                                        <div class="col-md-5 tab-con">
                                            <input type="text" name="company_type" value="{{ !empty($meta['company_type']) ? $meta['company_type'] : '' }}" class="form-control">
                        ...
                        <ul class="submenu">
                            ...
                            <form method="post" class="form-horizontal" action="/user/profile/meta/store">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 tab-con">
                                        <!--<input type="text" class="form-control" name="division" value="{!! !empty($meta['division']) ? $meta['division'] : '' !!}">-->
                                        <select name="division" class="form-control font-s division-list">
                                            <option value=""> Select a division</option>
                                            @if(count($divisions) > 0)
                                                @foreach($divisions as $list)
                                                 <option value="{{ $list->division_name }}" @if($list->division_name == (!empty($meta['division']) ? $meta['division'] : '')) selected="selected" @endif> {{ $list->division_name }} </option>
                                                @endforeach
                                            @endif 
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3 tab-con">
                                        <input type="text" name="district" value="{{ !empty($meta['district']) ? $meta['district'] : '' }}" class="form-control">
                                    </div>
