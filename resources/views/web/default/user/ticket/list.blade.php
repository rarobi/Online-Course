                ...
                <div class="body">
                    <form method="post" action="/user/ticket/store">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="inputDefault" @if(!empty(request()->get('type')) && request()->get('type') == 'become_vendor') value="{!! trans('main.become_vendor_title') !!}" @endif required>
                        </div>
