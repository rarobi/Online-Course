...
@extends($user['vendor'] == 1 ? getTemplate() . '.user.layout.balancelayout' : getTemplate() . '.user.layout.balancelayout')
@section('tab1','active')
@section('tab')
    <div class="h-20"></div>
    @if(count($lists) == 0)
        <div class="text-center">
            ...
            <span class="empty-second-line">
                ...
                <a href="/user/content/venu/create">{{ trans('main.upload_page') }}</a>
                ...
                @foreach($lists as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="/user/content/venu_edit/{{ $item->id }}" title="Edit" class="gray-s"><span class="crticon mdi mdi-lead-pencil"></span></a>
