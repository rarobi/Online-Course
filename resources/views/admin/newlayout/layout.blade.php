                ...
                <ul class="sidebar-menu">
                    ...
                    @if(checkAccess('venu'))
                        <li class="dropdown" id="venu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="/admin/content/venu/list">{{  trans('admin.list') }}</a></li>
                                <li><a class="nav-link @if(isset($alert['content_waiting']) and $alert['content_waiting'] > 0) beep beep-sidebar @endif" href="/admin/content/venu/waiting">Pending Venues</a></li>
                                <li><a class="nav-link @if(isset($alert['content_draft']) and $alert['content_draft'] > 0) beep beep-sidebar @endif" href="/admin/content/venu/draft">Unpublished Venues</a></li>
