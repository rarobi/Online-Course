@extends('admin.newlayout.layout',['breadcom'=>['Courses','Facilities']])
@section('title')
    Course Facilities
@endsection
@section('page')
                        ...
                        <table class="table table-bordered table-striped mb-none" id="datatable-details">
                            ...
                            @foreach($lists as $list)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/admin/content/facility-edit/{{ $list->id }}" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                        <a href="#" data-href="/admin/content/facility-delete/{{ $list->id }}" title="Delete" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
