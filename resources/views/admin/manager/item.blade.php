                    ...
                    <div id="capatibility" class="tab-pane">
                        <form action="/admin/manager/capatibility/{{$user->id}}" class="form-horizontal form-bordered" method="post">
                            ...
                            <div class="custom-switches-stacked">
                                ...
                                <!--</label>-->
                                <!--<label class="custom-switch">-->
                                <!--    <input type="checkbox" name="capatibility[]" value="certificates" class="custom-switch-input" @if(!empty($meta['capatibility'])) {{ checkedInArray('certificates',$meta['capatibility'],true) }} @endif />-->
                                <!--    <span class="custom-switch-indicator"></span>-->
                                <!--    <label class="custom-switch-description" for="inputDefault">{{ trans('admin.certificates') }}</label>-->
                                <!--</label>-->
                                <!--<label class="custom-switch">-->
                                <!--    <input type="checkbox" name="capatibility[]" value="live" class="custom-switch-input" @if(!empty($meta['capatibility'])) {{ checkedInArray('live',$meta['capatibility'],true) }} @endif />-->
                                <!--    <span class="custom-switch-indicator"></span>-->
                                <!--    <label class="custom-switch-description" for="inputDefault">{{ trans('admin.meeting') }}</label>-->
                                <!--</label>-->
                                <!--<label class="custom-switch">-->
                                ...
                                <!--</label>-->
                                <label class="custom-switch">
                                    <input type="checkbox" name="capatibility[]" value="admin" class="custom-switch-input" @if(!empty($meta['capatibility'])) {{ checkedInArray('admin',$meta['capatibility'],true) }} @endif />
                                    <span class="custom-switch-indicator"></span>
                                    <label class="custom-switch-description" for="inputDefault"> Admin</label>
                                </label>
                                <label class="custom-switch">
                                    <input type="checkbox" name="capatibility[]" value="course" class="custom-switch-input" @if(!empty($meta['capatibility'])) {{ checkedInArray('course',$meta['capatibility'],true) }} @endif />
                                    <span class="custom-switch-indicator"></span>
                                    <label class="custom-switch-description" for="inputDefault"> Editor Course Post</label>
                                </label>
                                <label class="custom-switch">
                                    <input type="checkbox" name="capatibility[]" value="venu" class="custom-switch-input" @if(!empty($meta['capatibility'])) {{ checkedInArray('venu',$meta['capatibility'],true) }} @endif />
                                    <span class="custom-switch-indicator"></span>
