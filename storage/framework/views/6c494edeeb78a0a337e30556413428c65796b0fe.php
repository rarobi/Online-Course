...
<?php $__env->startSection('tab'); ?>
    ...
    <?php if(count($lists) == 0): ?>
        <div class="text-center">
            ...
            <div class="h-20"></div>
            <span class="empty-first-line"> Venue Not found</span>
            <div class="h-10"></div>
            <span class="empty-second-line">
                <span><?php echo e(trans('main.go_to')); ?></span>
                <a href="/user/content/venu/create"><?php echo e(trans('main.upload_page')); ?></a>
                ...
                <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="/user/content/venu_edit/<?php echo e($item->id); ?>" title="Edit" class="gray-s"><span class="crticon mdi mdi-lead-pencil"></span></a>
...
<?php echo $__env->make($user['vendor'] == 1 ? getTemplate() . '.user.layout.balancelayout' : getTemplate() . '.user.layout.balancelayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crbangla1234/laravel/resources/views/web/default/user/venu/list.blade.php ENDPATH**/ ?>