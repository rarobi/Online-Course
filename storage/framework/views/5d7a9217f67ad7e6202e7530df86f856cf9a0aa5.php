                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 pagi-content tab-con">
                                        <a href="<?php echo e(!empty($content->content_id) ? '/product/'. $content->content_id : 'javascript:void(0);'); ?>" title="<?php echo e($content->title); ?>" class="content-box pagi-content-box">
                                            <div class="img-container text-center center-block">
                                                <img alt="<?php echo e($content->title ?? ''); ?>" src="<?php echo e($content->image); ?>"/>
                                            </div>
...
<?php echo $__env->make(getTemplate().'.view.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crbangla1234/laravel/resources/views/web/default/view/record/record.blade.php ENDPATH**/ ?>