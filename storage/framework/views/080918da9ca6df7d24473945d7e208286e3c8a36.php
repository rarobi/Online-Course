                            ...
                            <div class="form-group">
                                ...
                                <?php if(count($free_features) > 0): ?>
                                    <?php $__currentLoopData = $free_features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <input type="checkbox" name="free_feature[]" value="<?php echo e($list->name); ?>"> <?php echo e($list->name); ?>
                                ...
                                <div class="col-md-10 tab-con">
                                 <?php if(count($paid_features) > 0): ?>
                                    <?php $__currentLoopData = $paid_features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <input type="checkbox" name="paid_feature[]" value="<?php echo e($list->name); ?>"> <?php echo e($list->name); ?>
...
<?php echo $__env->make(getTemplate().'.user.layout.sendvideolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crbangla1234/laravel/resources/views/web/default/user/content/venu_create.blade.php ENDPATH**/ ?>