            ...
            <div class="container">
                <div class="col-md-4 col-xs-12 course_details">
                    ...
                    <div class="product-details-box">
                        ...
                        <span class="pn-category" style="display:contents"><?php echo e(isset($product->address) ? $product->address : 'Not Provided'); ?></span>
                    </div>
                    <br>
                    <!--<div class="product-details-box">-->
                    <!--    <span class="proicon mdi mdi-alarm"></span>-->
                    <!--    <span><?php echo e(date('d F Y',$product->created_at)); ?></span>-->
                    <!--</div>-->
                    <div class="product-details-box">
                    ...
                    <div class="product-details-box">
                        ...
                        <span>
                            Available Seat <?php echo e(isset($product->available_seat) ? $product->available_seat : '0'); ?>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="row">
                        ...
                        <div class="course_details">
                            ...
                            <div class="product-user-box-footer">
                                <a href="/profile/<?php echo e($product->user->id); ?>"> Company Profile</a>
                            </div>
                            <div class="h-25"></div>
                        </div>
                    </div><br>
                    <div class="row">
                        ...
                        <?php if(isset($sidebar_top_ad)): ?>
                            <a href="<?php echo e($sidebar_top_ad->url); ?>"><img src="<?php echo e($sidebar_top_ad->image); ?>" class="col-md-12 col-sm-12 col-xs-12" id="ppage-s"></a>
                        <?php else: ?>
                            <a href="#"><img src="<?php echo e(asset('assets/default/images/dummy-add.jpg')); ?>" class="col-md-12 col-sm-12 col-xs-12" id="ppage-s"></a>    
                        <?php endif; ?>
                    ...
                    <div class="row">
                        ...
                        <?php if(isset($sidebar_mid_ad)): ?>
                            <a href="<?php echo e($sidebar_mid_ad->url); ?>"><img src="<?php echo e($sidebar_mid_ad->image); ?>" class="col-md-12 col-sm-12 col-xs-12" style="height:200px"></a>
                        <?php else: ?>
                    ...
                    <div class="row">
                        ...
                        <?php if(isset($sidebar_bottom_ad)): ?>
                            <a href="<?php echo e($sidebar_bottom_ad->url); ?>"><img src="<?php echo e($sidebar_bottom_ad->image); ?>" class="col-md-12 col-sm-12 col-xs-12" style="height:200px"></a>
                        <?php else: ?>
                            <a href="#"><img src="<?php echo e(asset('assets/default/images/dummy-add.jpg')); ?>" class="col-md-12 col-sm-12 col-xs-12" style="height:200px"></a>    
                        <?php endif; ?>
                ...
                <div class="col-md-8 col-xs-12 product-part-container">
                    <div class="user-tabs">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tab6">
                                <span><?php echo $product->live_url ?? ''; ?></span>
                            </div>
                            ...
                            <!--<div class="<?php if(count($parts) == 0): ?> active in <?php endif; ?> tab-pane fade" id="tab6">-->
                            <div class=" tab-pane fade" id="tab6">
                    ...
                    <div class="h-20"></div>
                     ...
                     <div class="row">
                        ...
                        <!--    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
                        <!--<?php endif; ?>-->
                        <?php if(isset($slider_course_ad)): ?>
                            <a href="<?php echo e($slider_course_ad->url); ?>"><img src="<?php echo e($slider_course_ad->image); ?>" class="<?php echo e($slider_course_ad->size); ?>" style="height:200px"></a>
                        <?php else: ?>
                            <a href="#"><img src="<?php echo e(asset('assets/default/images/dummy-add.jpg')); ?>" class="col-md-12 col-sm-12 col-xs-12" style="height:200px"></a>    
                        <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="" dir="rtl" style="margin: 8px;">
                                        <a href="/product/<?php echo e($rel->id); ?>" title="<?php echo e($rel->title); ?>" class="content-box ">    
                                            <!--<img alt="<?php echo e($rel->title ?? ''); ?>" src="<?php echo e($rmeta['thumbnail']); ?>"/>-->
                                              <?php if($rel->thumbnail_photo): ?>
                                                <img src="/uploads/content_thumbnails/<?php echo e($rel->thumbnail_photo); ?>" class="img img-responsive img-thumbnail">
                                            <?php else: ?>
                                            ...
                                            <!--<p style="float:left;"><?php echo e($rel->district); ?></p>-->
                                            <!--<p><label class="pull-left"><?php echo e(currencySign()); ?> <?php echo e($rel->price); ?></label></p>-->
                                            <div class="footer">
                                                <!--<label class="pull-right content-clock"><?php echo e($rel->district); ?></label>-->
                                                <!--<span class="mdi mdi-map-marker pull-right"></span>-->
                                                <span class="mdi mdi-wallet pull-left"></span>
                                                <label class="pull-left"><?php echo e(currencySign()); ?> <?php echo e($rel->price); ?></label>
                                            </div>
                                        </a>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make(getTemplate().'.view.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crbangla1234/laravel/resources/views/web/default/view/product/product.blade.php ENDPATH**/ ?>