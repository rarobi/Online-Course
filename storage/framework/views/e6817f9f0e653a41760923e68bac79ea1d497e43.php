                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 tab-con">
                                        <select name="content_type" class="form-control font-s">
                                            <option value="mp4" <?php if(isset($item) && $item->content_type == 'mp4'): ?> selected <?php endif; ?>>Mp4</option>
                                            <option value="captivate" <?php if(isset($item) && $item->content_type == 'captivate'): ?> selected <?php endif; ?>>Adobe Captivate Zip</option>
                                        </select>
                                    </div>
                                </div>
                            <?php endif; ?>
                                ...
                                <li class="open edit-part-section dnone">
                                    ...
                                    <div class="submenu dblock">
                                        ...
                                        <form action="/user/content/part/edit/store/" id="step-5-form-edit-part" method="post" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label tab-con col-md-2 label-video-file"><?php echo e(trans('main.video_file')); ?></label>
                                                <div class="col-md-7 tab-con">
                                                    <div class="input-group asdf">
                                                        <?php if($item->content_type != 'captivate'): ?><span class="input-group-addon view-selected img-icon-s" data-toggle="modal" data-target="#VideoModal" data-whatever="upload_video"><span class="formicon mdi mdi-eye"></span></span><?php endif; ?>
                                                        ...
                                                        <?php if($item->content_type != 'captivate'): ?><span data-toggle="modal" href="#vimeo-modal" class="input-group-addon click-for-vimeo img-icon-s"><span class="formicon mdi mdi-vimeo"></span></span><?php endif; ?>
                                                    </div>
                                                </div>
                                ...
                                <li class="open">
                                    ...
                                    <div class="submenu dblock">
                                        ...
                                        <form action="/user/content/part/store" id="step-5-form-new-part" method="post" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-2 tab-con"><?php if($item->content_type != 'captivate'): ?><?php echo e(trans('main.video_file')); ?><?php else: ?> Captivate Zip File <?php endif; ?></label>
                                                <div class="col-md-7 tab-con">
                                                    <style>
                                                        .asdf {
                                                            display: flex;
                                                    ...
                                                    <div class="input-group asdf">
                                                        <?php if($item->content_type != 'captivate'): ?><span class="input-group-addon view-selected img-icon-s" data-toggle="modal" data-target="#VideoModal" data-whatever="upload_video2"><span class="formicon mdi mdi-eye"></span></span><?php endif; ?>
...
<?php echo $__env->make(getTemplate().'.user.layout.sendvideolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crbangla1234/laravel/resources/views/web/default/user/content/edit.blade.php ENDPATH**/ ?>