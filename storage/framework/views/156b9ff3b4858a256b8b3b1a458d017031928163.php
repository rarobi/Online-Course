                            ...
                            <a href="/product/<?php echo e($popular->id); ?>/<?php echo \Illuminate\Support\Str::slug($popular->title) ?? ''; ?>" title="<?php echo e($popular->title); ?>" class="content-box" style="height: 330px">
                                ...
                                <div class="footer">
                                    ...
                                    <?php endif; ?>
                                     ...
                                     <p class=""><i class="fa fa-user-plus"></i>( <?php echo e($popular->view); ?>)</p>
                                    ...
                                    <?php endif; ?>
                                    <label class="pull-right content-clock"><?php echo e($popular->district); ?></label>
...
<?php /**PATH /home/crbangla1234/laravel/resources/views/web/default/view/parts/popular.blade.php ENDPATH**/ ?>